            ...
            <div class="mt-10 bg-white shadow overflow-hidden sm:rounded-lg">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($workOrder): ?>
                     <div class="px-4 py-5 sm:px-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">
                            <?php echo e($workOrder->vehicle->brand); ?> <?php echo e($workOrder->vehicle->model); ?>

                        </h3>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">
                            Placa: <?php echo e($workOrder->vehicle->plate); ?>
                    ...
                    <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
                        <dl class="sm:divide-y sm:divide-gray-200">
                            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                             ...
                             <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    <?php echo e($workOrder->area->name ?? 'N/A'); ?>

                                </dd>
                            </div>
                            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">Ingreso</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    <?php echo e($workOrder->created_at->format('d/m/Y H:i')); ?>
                        ...
                        <!-- Simple Timeline -->
                        <div class="p-6">
                            <h4 class="font-bold text-gray-700 mb-4">Progreso</h4>
                            <div class="relative">
                                <?php
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex flex-col items-center">
                                            <div class="bg-white px-2">
                                                <div class="h-4 w-4 rounded-full border-2 <?php echo e($index <= $currentStatusIndex ? 'bg-indigo-600 border-indigo-600' : 'border-gray-300'); ?>"></div>
                                            </div>
                                            <div class="mt-2 text-xs text-gray-500 capitalize"><?php echo e(str_replace('_', ' ', $step)); ?></div>
                                        </div>
                ...
                <?php else: ?>
                    <div class="px-4 py-5 sm:p-6 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No encontrado</h3>
                        <p class="mt-1 text-sm text-gray-500">No encontramos una orden activa para la placa <?php echo e($plate); ?>.</p>
                    </div>
...
<?php /**PATH /home/pdaniels/desarrollo/ges/resources/views/livewire/public-tracking.blade.php ENDPATH**/ ?>