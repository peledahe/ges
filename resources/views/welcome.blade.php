            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex flex-col items-center">
                    ...
                    @if (Route::has('login'))
                        <div class="mt-12">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="inline-flex items-center px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
                                    Ir al Dashboard
                            ...
                            @else
                                <a href="{{ route('login') }}" class="inline-flex items-center px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
                                    Comenzar Ahora
                                    <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                                    </svg>
                    ...
                    <div class="mt-16 text-center text-sm text-gray-500 dark:text-gray-400">
                        <p>Sistema de Gestión de Taller &copy; {{ date('Y') }}</p>
                        <p class="mt-2">Desarrollado con Laravel {{ Illuminate\Foundation\Application::VERSION }} (PHP {{ PHP_VERSION }})</p>
                    </div>
                </div>
            </div>
        </div>
