    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg p-8">
            <div class="text-center">
                ...
                <h3 class="mt-4 text-xl font-semibold text-gray-900 dark:text-white">{{ $data['message'] }}</h3>
                <p class="mt-2 text-gray-600 dark:text-gray-400">
                    Pronto podrás ver el estado de tus vehículos y órdenes de trabajo aquí.
                </p>
                <div class="mt-8">
                    <a href="{{ route('rastreo') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition">
